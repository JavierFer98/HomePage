...
//		panel1.setStyle("-fx-background-image: url('s1.jpg')");
//	panel2.setStyle("-fx-background-image: url('s2.jpg')");
//		panel3.setStyle("-fx-background-image: url('s3.jpg')");
//		panel4.setStyle("-fx-background-image: url('s4.jpg')");
